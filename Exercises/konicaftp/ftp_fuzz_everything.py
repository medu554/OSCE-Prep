...
def main():
	session = Session(check_data_received_each_request=True, receive_data_after_each_request=True,target=Target(connection=SocketConnection("10.250.95.19", 21, proto='tcp')))    
